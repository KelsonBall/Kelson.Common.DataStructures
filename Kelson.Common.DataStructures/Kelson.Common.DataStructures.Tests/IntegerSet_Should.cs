...
namespace Kelson.Common.DataStructures.Tests
{
    public class IntegerSet_Should
    {
        ...
        public void DetermineExclusion_FromSetOverDifferentRange()
        {
            ...
            seta = new IntegerSet(-12, 65) { -11, -8, -7, -3, -1, 0, 3, 5, 6, 8, 10, 11, 13, 14, 16, 17, 18, 19, 24, 26, 27, 28, 30, 32, 34, 35, 36, 38, 41, 42, 43, 44, 45, 46, 47, 48, 49 };
            setb = new IntegerSet(-26, 90) { -26, -25, -22, -21, -20, -18, -17, -15, -13, -10, -9, -8, -6, -5, -4, -3, -1, 0, 2, 3, 4, 6, 8, 9, 11, 12, 13, 14, 15, 16, 22, 24, 27, 29, 31, 34, 37, 39, 40, 41, 42, 45, 46, 47, 48, 49, 50, 51, 53, 54, 57, 58, 59, 60, 61, 62 };

            seta.ExceptWith(setb);
            result = seta.ToList();
            result.SequenceEqual(new int[] { -11, -7, 5, 10, 17, 18, 19, 26, 28, 30, 32, 35, 36, 38, 43, 44 })
                  .Should()
                  .BeTrue();
        }
